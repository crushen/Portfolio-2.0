<template>
  <svg
    ...
    <transition-group 
      name="list" 
      tag="g">
      <circle class="items circ circ-1" key="circ-1" cy="140" cx="250" r="120"/>
...
.work .circ-2 {
  transform: translate3d(-100px, -70px, 0) scale(0.8);
}

.contact .circ-2 {
  transform: translate3d(100px, 200px, 0) scale(0.8);
}
